        ...
        <div className='w-[88%] flex flex-col lg:flex-row justify-between space-y-10 lg:space-y-0'>
          <div className='lg:w-[55%]'>
            ...
            <p className='text-md font-light font-Poppins mt-5 lg:w-3/4 text-gray-500 text-justify'>
              ...
              therapies, all at affordable prices. We offer comprehensive
              holistic & wellness treatments with a blend of Indian & Thai
              culture, combined with body purification techniques, body scrubs &
              slimming packages, amongst other services, that relax, refresh &
              rejuvenate you completely, thoroughly, and from within. Rudra
              Hammam Spa embodies a groundbreaking concept in the Indian spa &
              salon industry: offering a pool of talented professionals the
              opportunity to breathe life into their passion and establish a
              platform for your business within the untapped and largely
              self-sufficient US $500 Million Spa & Salon Industry. Rudra Hammam
              Spa is proud to introduce the first-ever Authentic traditional
              Thai foot reflexology treatments in the heart of Ahmedabad through
              our Xpress model. Soon, you'll witness this model expanding to
              cities across the country, with the aim of providing the same Thai
